<template>
  <div class="flex min-h-screen bg-blue-700" :style="'background-image: url(' + require(`@/assets/3.png`) +')'">
    <div
      ...
      <img src="@/assets/loginpage.png" class="md:w-2/3 object-comt">
      <div class="flex md:w-1/2 text-left p-8">
        <div class="m-auto w-full">
          ...
          <div v-if="!$store.state.auth.access" class="grid grid-cols-3 gap-2 gap-x-5 my-5">
            ...
            <router-link hidden to="/signup" class="col-start-1 text-xs font-medium text-blue-600 col-span-3 after:content-['_↗']">
              Belum memiliki akun ?
            </router-link>
            <button @click="SignIn"
